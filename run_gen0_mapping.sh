...
GEN0_WORKSPACE="${GEN0_WORKSPACE:-$PWD}" \
GEN0_WORLD="${GEN0_WORLD:-my_map}" \
GEN0_MAPPING_DRIVE="${GEN0_MAPPING_DRIVE:-false}" \
GEN0_TRASH_CLEANUP="${GEN0_TRASH_CLEANUP:-true}" \
GEN0_TRASH_USE_MESH_VISUAL_CENTER="${GEN0_TRASH_USE_MESH_VISUAL_CENTER:-true}" \
GEN0_TRASH_VEHICLE_POSE_TOPIC="${GEN0_TRASH_VEHICLE_POSE_TOPIC-/gen0_model/links/poses}" \
GEN0_TRASH_VEHICLE_POSE_INDEX="${GEN0_TRASH_VEHICLE_POSE_INDEX:-15}" \
...
GEN0_RVIZ="${GEN0_RVIZ:-true}" \
GEN0_RVIZ_RENDER_ENV="${GEN0_RVIZ_RENDER_ENV:-passthrough}" \
GEN0_PROJECTED_MAP_BACKEND="${GEN0_PROJECTED_MAP_BACKEND:-python}" \
./run_gen0_3d_slam.sh &
SLAM_PID=$!
...
GEN0_WORKSPACE="${GEN0_WORKSPACE:-$PWD}" \
GEN0_NAV2_PROFILE="${GEN0_NAV2_PROFILE:-scurm_gen0}" \
GEN0_WORLD="${GEN0_WORLD:-my_map}" \
GEN0_NAV2_USE_RESPAWN="${GEN0_NAV2_USE_RESPAWN:-false}" \
GEN0_NAV2_RVIZ="${GEN0_NAV2_RVIZ:-true}" \
