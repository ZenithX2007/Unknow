...
if [[ "$START_BASE_STACK" == "true" ]]; then
  start_script \
    ...
    env \
      ...
      GEN0_TRASH_FUSION_DETECTION="${GEN0_TRASH_FUSION_DETECTION:-false}" \
      GEN0_CAMERA_VIEW="${GEN0_CAMERA_VIEW:-false}" \
      GEN0_CAMERA_TOPIC="${GEN0_CAMERA_TOPIC:-/gen0_model/front_camera}" \
