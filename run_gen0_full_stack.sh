...
for package_name in epsilon_planning qcnet_prediction gen0_nav2_path_exporter gen0_llm_agent sweeper_integration gen0_main yolo_detector rosbridge_server ros_gz_bridge; do
