...
TRASH_FUSION_MODEL_PATH="${GEN0_TRASH_FUSION_MODEL_PATH:-$WORKSPACE/best_road.pt}"
...
CAMERA_VIEW="${GEN0_CAMERA_VIEW:-false}"
...
RELOCALIZATION_INPUT_CLOUD_TO_BASE_X="${GEN0_RELOCALIZATION_INPUT_CLOUD_TO_BASE_X:-0.85}"
RELOCALIZATION_INPUT_CLOUD_TO_BASE_Y="${GEN0_RELOCALIZATION_INPUT_CLOUD_TO_BASE_Y:-0.0}"
RELOCALIZATION_INPUT_CLOUD_TO_BASE_Z="${GEN0_RELOCALIZATION_INPUT_CLOUD_TO_BASE_Z:-0.72}"
...
start_process relocalization_3d_slam \
  env \
    ...
    GEN0_CAMERA_VIEW="$CAMERA_VIEW" \
    GEN0_CAMERA_TOPIC="$CAMERA_TOPIC" \
