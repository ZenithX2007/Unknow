 ...
 * @author GW
 * @brief Frenet Bézier 轨迹头文件
 * @version 0.1
 * @date 2019
 * @copyright Copyright (c) 2019
 *
 * **文件概述**：
 * 本文件定义 Frenet 域下的 Bézier 轨迹对象。
 */
...
class FrenetBezierTrajectory : public FrenetTrajectory {
 public:
  ...
  ErrorType GetState(const decimal_t& t, State* state) const override {
    ...
    // SSC 在 (s, d, t) 中优化，执行和碰撞接口仍需要世界坐标状态。
