 ...
 * @file visualizer.h
 * @author GW
 * @brief 语义地图可视化器接口：车道、车辆、障碍物、行为与预测结果展示
 * @version 0.1
 * @date 2019
 * @copyright Copyright (c) 2019
 *
 * **文件概述**：
 * 本文件声明 `semantic_map_manager::Visualizer`，
 * 用于将 `SemanticMapManager` 中缓存的地图、车辆、预测和行为结果
 * 发布为 RViz Marker/OccupancyGrid。
 */
