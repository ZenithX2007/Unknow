...
VEHICLE_MAX_FORWARD_SPEED="${GEN0_VEHICLE_MAX_FORWARD_SPEED:-2.25}"
VEHICLE_MAX_REVERSE_SPEED="${GEN0_VEHICLE_MAX_REVERSE_SPEED:-1.25}"
VEHICLE_MAX_ANGULAR_Z="${GEN0_VEHICLE_MAX_ANGULAR_Z:-0.50}"
