...
class ProjectedTerrainMap(Node):
    def __init__(self):
        ...
        self.declare_parameter("free_intensity_threshold", 0.04)
        self.declare_parameter("occupied_intensity_threshold", 0.08)
        self.declare_parameter("occupied_cost_intensity", 0.25)
        ...
        self.declare_parameter("occupied_log_odds_threshold", 1.35)
        ...
        self.declare_parameter("filter_speckles", True)
        self.declare_parameter("min_occupied_component_cells", 6)
        self.declare_parameter("min_occupied_component_span_cells", 4)
